...
def create_job_profile_template():
    ...
    basic_info = [
        ...
        ("Подразделение", ""),
        ("Категория должности", "Специалист/Линейный руководитель/Руководитель среднего уровня/Руководитель высшего уровня"),
    ...
    education_info = [
        ...
        ("Общий опыт работы", ""),
        ("Уровень образования", "Среднее общее/Среднее профессиональное/Высшее/Высшее неоконченное"),
        ("Специальность", ""),
