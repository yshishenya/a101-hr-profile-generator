...
**Текущий статус:** Backend Core готов ✅ | API в разработке 🔄 | Frontend в планах 📋 | Testing в планах 📋
...
### **1.3 Authentication API** ⏳ P0
**Файлы:** `/backend/api/auth.py`, `/backend/services/auth_service.py`
- [ ] Создать POST `/api/auth/login` endpoint  
- [ ] Реализовать простую session-based аутентификацию
- [ ] Добавить JWT токены с expiration
- [ ] Создать middleware для проверки авторизации
- [ ] Добавить logout endpoint

**Definition of Done:**
- ✅ Можно войти с валидными credentials
- ✅ Возвращается JWT токен с правильным payload
- ✅ Protected endpoints требуют авторизации
- ✅ Невалидные токены отклоняются с 401

**Зависимости:** 1.1, 1.2 | **Время:** 5 часов

---

### **1.4 Catalog API Endpoints** ⏳ P1
...
**Зависимости:** 1.1, существующий OrganizationMapper | **Время:** 4 часа
