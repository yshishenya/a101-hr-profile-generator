...
def compare_structures():
    ...
    hierarchy_excel = []
    prev = None
    for col in ['Уровень 2', 'Уровень 3', 'Уровень 4', 'Уровень 5', 'Уровень 6', 'Уровень 7']:
    ...
    json_managers = find_all_positions(json_data['organization'], 'Руководитель управления')
    ...
    def count_depths(node, current_depth):
        for unit_name, unit_data in node.items():
            ...
            depth_counts_json[current_depth] = depth_counts_json.get(current_depth, 0) + positions_count
