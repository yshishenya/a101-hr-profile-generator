...
from .exceptions import (
    ...
    ExternalAPIError, ConfigurationError, ProfileGenerationError,
    RateLimitError
)
...
def create_not_found_error(resource: str, resource_id: str = None, **kwargs) -> NotFoundError:
...
def create_external_api_error(service: str, operation: str, **kwargs) -> ExternalAPIError:
