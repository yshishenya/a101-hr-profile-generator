...
class Config:
    ...
    GENERATED_PROFILES_DIR: str = os.getenv("GENERATED_PROFILES_DIR", "generated_profiles")
    ...
    def validate(self) -> bool:
        ...
        if self.ENVIRONMENT == "production" and self.JWT_SECRET_KEY.endswith("-change-in-production"):
